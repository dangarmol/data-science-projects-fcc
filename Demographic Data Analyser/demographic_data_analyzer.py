...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((adv_over_50k / adv_edu_count) * 100, 1)
    lower_education_rich = round((low_over_50k / low_edu_count) * 100, 1)
    ...
    rich_percentage = round((min_over_50k / min_hours_count) * 100, 1)
